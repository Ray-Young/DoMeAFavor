...
public class DetailPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get the information of the post from dataSingleton...
        /**
        posterName = dsl.getInstance().getName().get(postIdInt).toString();
        postTheme = dsl.getInstance().getTitle().get(postIdInt).toString();
        postDetail = dsl.getInstance().getPostContent().get(postIdInt).toString();
        postLocation = dsl.getInstance().getLocation().get(postIdInt).toString();
        postDate = dsl.getInstance().getDate().get(postIdInt).toString();
        postUserId = Integer.parseInt(dsl.getInstance().getUserId().get(postIdInt).toString());
         postReward = "$" + dsl.getInstance().getReward().get(postIdInt).toString();
         **/
        try {
...
//                Intent picClick = new Intent(getApplicationContext(),ProfileActivity.class);
//                picClick.putExtra("image",profileBitmap);
//                picClick.putExtra("name",posterName);
//                getApplicationContext().startActivity(picClick);
//            }
//        });
    }
